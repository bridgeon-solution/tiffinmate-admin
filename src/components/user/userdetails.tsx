      ...
      <Box
        ...
        <Grid container spacing={2} mt={2} display="flex" direction="column" >
          <Grid item xs={12} sm={6}  marginBottom={5} >
            ...
            <Typography variant="body2" color="#6B7280" >
              Address:<br/><strong>{userDetails?.address}</strong> 
            </Typography>
          </Grid>
          <Divider/>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body2" mb={2} color="#6B7280">
              Account Status:<br/>
              <span ><strong>{userDetails?.is_blocked?<span style={{color:"red"}}>In Active</span>:<span style={{color:"green"}}>Active</span>}</strong></span>
            </Typography>
            <Typography variant="body2"color="#6B7280">
              Last Login:<br/>
              <span  style={{ color: "red" }}><strong>10 min</strong></span>
            </Typography>
            <Typography variant="body2" color="#6B7280">
              Subscription Status:<br/>
              <span ><strong>{userDetails?.subscription_status?<span style={{color:"green"}}>Active</span>:<span style={{color:"red"}}>In Active</span>}</strong></span>
            </Typography>
            </Grid>
          ...
          <Typography variant="subtitle1" fontWeight="bold" mb={1}>
            ...
            <Typography variant="body2" color="#6B7280" >
              Payment Status:<br/><strong>2000-<span style={{color:"green"}}>paid</span></strong> 
            </Typography>
          </Grid>
